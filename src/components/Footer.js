...
function Footer() {
    return(
        ...
        <footer>
            ...
            <p className="text">Address : Raheja Complex , Kalyan,Mumbai</p>
            <p className="text">Phone : +91 789076567</p>
            <p className="text">Email : shazmeen@gmail.com</p>
            </div>
            </div>

        <div><br /><br />
            <p id="rights">All Rights Reserved.</p><br />
        </div>
        </footer>
    </div>
);
